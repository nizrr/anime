        ...
        <>
            ...
            <div
                ...
                className={`group relative flex w-full items-center justify-between py-24 border-b border-white/20 cursor-none ${
                    index % 2 === 0
                        ? "flex-row"
                        : "flex-row-reverse" /* Selang-seling kiri kanan */
                }`}
            ...
            >
                <div className="w-5/12 px-10">
                    <span className="mb-4  text-xs font-medium uppercase tracking-[0.2em] inline-flex items-center gap-2 text-gray-400">
                        ...
                        <Icon icon="ic:round-star" color="yellow" />{" "}
                        {data.score}
                    </span>
                    <h2 className="text-6xl font-black uppercase leading-[0.9] tracking-tighter text-white transition-colors duration-500 group-hover:text-primary">
                        {data.title}
                    </h2>
                ...
                <div className="relative h-[500px] w-6/12 overflow-hidden bg-gray-900 rounded-lg">
                    <motion.div
                        style={{ y, scale }}
...
export default function AnimeGallery({
    ...
    return (
        <section className="bg-background min-h-screen w-full px-4 md:px-20 py-20 relative z-50">
            <div className="mb-20 border-b border-white/10 pb-10">
                <h1 className="text-8xl font-thin text-white tracking-tighter">
                    <span className="font-bold text-primary">Trending</span> Now
                </h1>
            </div>
