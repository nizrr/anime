                ...
                <CarouselContent className="-ml-4 ">
                    {data?.map((anime: any, index: number) => {
                        ...
                        return (
                            <CarouselItem
                                key={index}
                                className="pl-4 border-0 font-clash"
                            >
                                <div className="bg-accent h-[calc(100dvh-200px)] overflow-hidden relative w-full">
                ...
                <div className="flex gap-4">
                    {data?.map((anime: any, index: number) => (
                        <div
                            ...
                            className="w-full h-[150px] rounded-lg relative cursor-pointer"
                        >
                            <img
                                src={
